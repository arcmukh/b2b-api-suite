...
B2B Create Incident
    ...
    ${BODY}    Create Dictionary    username=administrator    password=admin123
    POST    http://${B2B_URL}/test-auth/api/v3/login    headers=${HEADER}    json=${BODY}    verify=False
    ...
    POST    http://${B2B_URL}/test-services/api/v3/incident    headers=${HEADER_NEW}    json=${BODY_NEW}    verify=False
    Sleep    5
...
B2B Update Incident
    ${HEADER}    Create Dictionary    Content-Type    application/json
    ${BODY}    Create Dictionary    username=administrator    password=admin123
    # Create Session    test_AUTH    http://${test_IP}
    POST    http://${B2B_URL}/test-auth/api/v3/login    headers=${HEADER}    json=${BODY}    verify=False
    ...
    ${BODY_NEW}    Create Dictionary    ticketType=incident    fields=${fields}    comments=@{Comments}
    PATCH    http://${B2B_URL}/test-services/api/v3/incident/3934    headers=${HEADER_NEW}    json=${BODY_NEW}    verify=False
    Sleep    5
...
B2B Create Problem
    ...
    POST    http://${B2B_URL}/test-services/api/v3/problem    headers=${HEADER_NEW}    json=${BODY_NEW}    verify=False
    Sleep    5
...
B2B Update Problem
    ...
    ${BODY_NEW}    Create Dictionary    ticketType=problem    fields=${fields}    comments=@{Comments}
    PATCH    http://${B2B_URL}/test-services/api/v3/problem/3934    headers=${HEADER_NEW}    json=${BODY_NEW}    verify=False
    Sleep    5
...
B2B Create Change
    ...
    POST    http://${B2B_URL}/test-services/api/v3/change    headers=${HEADER_NEW}    json=${BODY_NEW}    verify=False
    Sleep    5
...
B2B Update Change
    ...
    ${BODY_NEW}    Create Dictionary    ticketType=change    fields=${fields}    comments=@{Comments}
    PATCH    http://${B2B_URL}/test-services/api/v3/change/3934    headers=${HEADER_NEW}    json=${BODY_NEW}    verify=False
    Sleep    5
...
B2B Create Request
    ...
    POST    http://${B2B_URL}/test-services/api/v3/request    headers=${HEADER_NEW}    json=${BODY_NEW}    verify=False
    Sleep    5
...
B2B Update Request
    ...
    ${BODY_NEW}    Create Dictionary    ticketType=service_request    fields=${fields}    comments=@{Comments}
    PATCH    http://${B2B_URL}/test-services/api/v3/request/3934    headers=${HEADER_NEW}    json=${BODY_NEW}    verify=False
    Sleep    5
